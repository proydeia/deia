...
export default function About() {
  return (
    <div className="bg-white shadow-none md:shadow-xl z-30 w-full md:w-10/12 rounded-none md:rounded-xl flex flex-col items-center justify-center">
      <h1 className="text-2xl font-subtitulo sm:text-3xl font-bold text-center  w-full mb-4 mt-8">
        Conocé a nuestro equipo
      </h1>
      <div className="grid grid-cols-2 md:flex md:flex-row items-center justify-evenly m-8 gap-2 ">

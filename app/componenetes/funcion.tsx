export default function Funcion() {
    return (
        <div className="bg-white md:w-10/12 w-full p-8 rounded-none md:rounded-xl shadow-lg relative z-20">
            ...
            <div className="flex flex-col md:flex-row gap-6 mt-10">
                ...
                <div className="flex flex-row  md:flex-col justify-center items-center gap-4 w-full bg-white shadow-lg  rounded-xl">

export default function Funcion() {
    return (
        <div className="bg-white md:w-10/12 w-full p-8 rounded-xl shadow-lg">
            <h1 className="text-2xl sm:text-3xl font-bold text-center  w-full mb-4 mt-4">Funcionalidades</h1>
            <p className="text-lg font-light text-center">Estas son algunas funcionalidades que podés encontrar en DEIA</p>
            <div className="flex flex-row gap-6">

                <div className="flex flex-col justify-center items-center w-full bg-primary rounded-xl">
                    <div className="w-10 h-10 rounded-xl bg-third mt-6 mb-3"></div>
                    <h2 className="text-lg font-bold text-center mb-3">Resultados inmediatos</h2>
                    <p className="text-sm font-light text-center px-6 mb-6">En tan solo algunos segundos, nuestra IA se encargará de aportar al médico un análisis de la espirometría. </p>
                </div>
                <div className="flex flex-col justify-center items-center w-full bg-primary rounded-xl">
                    <div className="w-10 h-10 rounded-xl bg-third mt-6 mb-3"></div>
                    <h2 className="text-lg font-bold text-center mb-3">Resultados inmediatos</h2>

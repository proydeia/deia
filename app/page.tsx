    ...
    <main className="overscroll-x-contain overflow-hidden flex flex-col justify-center bg-fondo_light ">
      ...
      <section className="relative hero-section z-30 md:flex hidden justify-around items-center  w-full pt-36 mt-6  pb-0 mb-10 bg-fondo_light ">
        ...
        <div className="relative  h-11/12">
          <div className="animate-jump animate-infinite animate-duration-[20000ms] absolute z-10 top-80 -right-10 rounded-full ring-inset ring-third ring-8  border-8 border-third h-28 w-28 "></div>
          <div className="animate-jump animate-infinite animate-duration-[30000ms] absolute z-10 top-52   -right-40 rounded-full ring-inset ring-primary ring-8  border-8 border-primary h-32 w-32 "></div>
          <div className="animate-jump animate-infinite animate-duration-[20000ms] absolute z-20 top-2 4 -right-36 rounded-full bg-primary h-1/5 w-1/5"></div>
          <div className="animate-jump  animate-infinite animate-duration-[50000ms] absolute z-4  -right-40 top-20 rounded-full bg-primary_light h-80 w-80 "></div>
          <Image
            src="/Frame9.png"
            alt="Mi imagen"
            layout="fixed"
            width={400}
            height={400}
            className="relative -top-10 z-5 animate-rotate-y animate-once animate-delay-[20000ms]  animate-ease-in-out animate-normal "
          />
        </div>
      </section>
      <section className="our-mission relative pt-10 w-full bg-fondo_light pb-0 md:pb-10 flex justify-center items-center">
        {/* Our Mission content */}
        <Funcion />
        <div className="md:block animate-bounce animate-infinite animate-duration-[20000ms] animate-delay-1000 animate-ease-linear animate-fill-both absolute z-10  bottom-80 -left-9 rounded-full ring-inset ring-third ring-8  border-8 border-third h-20 w-20 "></div>
        <div className="md:block  absolute z-10 -bottom-24 -left-20  rounded-full bg-primary_light h-80 w-80 "></div>
        <div className="md:block  animate-bounce animate-infinite animate-duration-[15000ms] animate-delay-1000 animate-ease-linear animate-fill-both  absolute z-10  -bottom-10 -left-9  rounded-full ring-inset ring-primary ring-8  border-8 border-primary h-32 w-32 "></div>
        <div className="md:block  animate-bounce animate-infinite animate-duration-[10000ms] animate-delay-1000 animate-ease-linear animate-fill-both  absolute z-10  bottom-48 left-10  rounded-full bg-primary h-20 w-20"></div>
      </section>
      <section className=" relative w-full pb-0 md:pb-10 flex justify-center items-center">
        ...
        <div className="hidden animate-bounce animate-infinite animate-duration-[15000ms] animate-delay-1000 animate-ease-linear animate-fill-both md:block absolute z-10  -bottom-40 -right-9 rounded-full ring-inset ring-primary ring-8  border-8 border-primary h-20 w-20 "></div>
        <div className="hidden animate-bounce animate-infinite animate-duration-[10000ms] animate-delay-1000 animate-ease-linear animate-fill-both md:block absolute z-10  bottom-40 -right-1  rounded-full bg-primary h-20 w-20"></div>
